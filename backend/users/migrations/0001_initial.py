    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Username can only contain letters, digits, and the following symbols: @/./+/-/_', regex='^[\\w.@+-]+\\Z')], verbose_name='Username')),
